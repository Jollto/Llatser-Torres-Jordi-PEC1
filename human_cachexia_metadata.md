# Dataset de Human Cachexia

## Descripció

Aquest conjunt de dades conté informació sobre pacients amb i sense cachexia, una condició associada amb la pèrdua de massa muscular.

## Columnes

-   **Patient ID**: Identificador únic de cada pacient.
-   **Muscle loss**: Indica la condició de pèrdua muscular dels pacients (cachexic o no).
...
-   **Compounds**: Concentracions de diferents compostos metabòlics.
